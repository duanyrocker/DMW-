<?php
include('../CONTROLLER/verificaSessao.php');
?>
<!DOCTYPE html>
<html lang="pt-br">
                ...
                <div class="col-md-10 ml-auto mr-auto">
                    <div class="card shadow-lg border-0 rounded-lg mt-3">
                         ...
                         <div class="card-header">
                            <h2 class="text-center my-2">Produtos Cadastrados:</h2>
                        </div>
                        <!-- Light table -->
                        <form name="frmProd" class="frmProd mt-3" id="frmProd" action="" method="POST">
                            <div class="input-group mb-3 p-2">
                                <input type="text" class="form-control" id="nomeProd" name="nomeProd" placeholder="Pesquisar" aria-label="Recipient's username" aria-describedby="basic-addon2"></input>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                include_once '../CONTROLLER/php/readProdFun.php'
                                ?>
                            </tbody>
                        </table>
                        <!-- Card footer -->
    ...
    <script>
        ...
        $(function() {
            $('.formProd').submit(function() { //Linha para submit, quando o usuário apertar o botão
                $.ajax({
                    url: '../CONTROLLER/php/readProdFun.php', //Arquivo php que fará as validações
